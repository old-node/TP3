...
{ Keyboard::Up,	Keyboard::Down,	Keyboard::Left,	Keyboard::Right,Keyboard::Z,	Keyboard::X },		// Joueur par défaut
...
private:
	...
	// Utiliser la struct joueur		(mettre les valeurs de base en instanciation)
...
bool salle::pivoteActifGauche()
{
	...
	_blocActif.getAxes(axes, angle);

	if (!colisionActifTourne(axes))
	{
